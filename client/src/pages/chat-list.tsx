              ...
              >
                <div className="flex items-center">
                  <div className="relative">
                    ...
                    {chat.unreadCount > 0 && (
                      <div className="absolute -top-1 -right-1 bg-primary text-white text-xs rounded-full w-5 h-5 flex items-center justify-center shadow-sm border border-white">
                        {chat.unreadCount}
                      </div>
                    )}
                  </div>
