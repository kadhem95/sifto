  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-neutral-200 flex items-center justify-around p-2 max-w-lg mx-auto">
      ...
      <Link href="/my-shipments">
        <a className={`flex flex-col items-center p-2 ${isActive("/my-shipments")}`}>
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <Link href="/chat/list">
        <a className={`flex flex-col items-center p-2 ${isActive("/chat/list") || location.startsWith("/chat/") ? "text-primary" : "text-neutral-500"}`}>
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <Link href="/profile">
        <a className={`flex flex-col items-center p-2 ${isActive("/profile")}`}>
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
